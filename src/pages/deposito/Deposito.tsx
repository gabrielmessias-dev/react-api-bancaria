    ...
    <MainLayout>
      <div className="max-w-md mx-auto">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">Depósito</h1>
          <p className="text-slate-500 font-medium">Abasteça sua conta instantaneamente.</p>
        </header>
        ...
        >
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase ml-1">Valor para depositar</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border-2 border-slate-50 p-5 pl-14 rounded-2xl text-2xl font-bold text-slate-700 focus:border-emerald-500 focus:bg-white outline-none transition-all placeholder:text-slate-200"
              />
            </div>
          </div>
          ...
          <button 
            ...
            className={`w-full py-5 rounded-2xl font-black text-white text-lg transition-all shadow-lg active:scale-[0.98] ${
              loading ? "bg-slate-300 cursor-not-allowed" : "bg-emerald-500 hover:bg-emerald-600 shadow-emerald-200 cursor-pointer"
            }`}
          >
